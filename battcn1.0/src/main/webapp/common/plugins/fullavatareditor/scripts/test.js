		...
		.addDomLoadEvent(function() {
			...
			var callback = function(json) {
				...
				case 3:
					...
					break;
				case 4:
					layer.alert("您选择的原图片文件大小（" + json.content + "）超出了指定的值(2MB)。");
					break;
				case 5:
					// 如果上传成功
					if (json.type == 1)
					{
						layer.alert("头像上传成功",function(){
			...
			var swf1 = new fullAvatarEditor('swf1', 335, {
				id : 'swf1',
				upload_url : rootPath+'/user/upload.shtml',
			...
			// ------------------------------------------------------------------------------示例二
			var swf2 = new fullAvatarEditor(
					'swf2',
					{
						id : 'swf2',
						upload_url : rootPath+'/user/upload.shtml', // 上传图片的接口地址
